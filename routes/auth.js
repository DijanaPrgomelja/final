...
router.post('/signup', (req, res, next) => {
	...
	const { role, username, password, profilePicture, firstName, lastName, email, typeOfTherapy, therapyDescription, recomentedTherapists} = req.body;
	// validation
	...
	User.findOne({ username: username })
		.then(userFromDB => {
			...
			if (userFromDB !== null) {
				...
				User.create({ role: role, username: username, password: hash, profilePicture: profilePicture, firstName: firstName, lastName: lastName, email: email, typeOfTherapy: typeOfTherapy, therapyDescription: therapyDescription, recomentedTherapists: recomentedTherapists})
					.then(createdUser => {
